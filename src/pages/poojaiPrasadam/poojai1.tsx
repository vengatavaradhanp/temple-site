...
const Poojai1 = () => {
  ...
  const poojai1data = useSelector((state: RootState) => state.anandhanam.data);
  console.log("poojai1data", poojai1data);
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      await dispatch(anandhanam("poojai1"));
      setLoading(false);
    };
