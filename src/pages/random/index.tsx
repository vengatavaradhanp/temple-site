...
//   const randomdata = useSelector((state: RootState) => state.contact.data);
//   const [loading, setLoading] = useState(true);

//   useEffect(() => {
//     const fetchData = async () => {
//       setLoading(true);
//       await dispatch(contactDetails("random"));
//       setLoading(false);
//     };
...
const Index = () => {
  const dispatch: AppDispatch = useDispatch();
  const random = useSelector((state: RootState) => state.contact.data);
  const [loading, setLoading] = useState(true);
